...
namespace odingine {
	...
	IGameScreen* odingine::ScreenList::moveNext() {
	...
	IGameScreen* odingine::ScreenList::movePrevious() {
		IGameScreen* currentScreen = getCurrent();
	...
	void odingine::ScreenList::setScreen(int nextScreen) {
		m_currentScreenIndex = nextScreen;
	}

	void odingine::ScreenList::addScreen(IGameScreen* newScreen) {
	...
	void odingine::ScreenList::destroy() {
